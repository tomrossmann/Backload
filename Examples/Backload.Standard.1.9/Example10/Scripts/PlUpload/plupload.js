                ...
                self.bind('FilesAdded', function (up, selected_files) {
                    ...
                    next_file:
                        for (i = 0; i < selected_files.length; i++) {
                            ...
                            // file.loaded = 0; // Backload private build (Original:: file.loaded = 0)
                            // file.percent = 0; // Backload private build (Original:: file.percent = 0)
                            // file.status = plupload.QUEUED; // Backload private build (Original:: file.status = plupload.QUEUED;)
    ...
    plupload.File = (function () {
        ...
        function PluploadFile(file) {
            ...
            plupload.extend(this, {
                 ...
                 * @see plupload
                 */
                status: 1,  // Backload private build. (original:: status: 0)
