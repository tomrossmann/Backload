...
$(function () {
    ...
    // Use the builtin file upload handler (integrated into Backload).
    var fileUploadUrl = "/Backload/UploadHandler";

    // Test 1: Call the derived handler method (FileUploadDerivedController)
    // var fileUploadUrl = "/FileUploadDerived/UploadHandler";

    // Test 2: Call the instantiated handler method (FileUploadInstanceController)
